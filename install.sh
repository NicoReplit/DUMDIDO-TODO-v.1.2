...
# Run with: curl -sSL https://raw.githubusercontent.com/YOUR_USERNAME/family-dashboard/main/install.sh | bash
...
if [ -d "$APP_DIR" ]; then
    ...
    git clone https://github.com/YOUR_USERNAME/family-dashboard.git "$APP_DIR"
    cd "$APP_DIR"
fi
