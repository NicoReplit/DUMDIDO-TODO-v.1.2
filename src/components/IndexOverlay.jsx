...
export default function IndexOverlay() {
  const indexes = [
    ...
    { id: 3, label: 'Date Pill (input-date-pill)', top: '10vh', right: '3%', transform: 'translateY(-50%)' },
    ...
    { id: 10, label: 'Blue Circle (celebration-circle-wiggle)', bottom: 'calc(-90px + 24vmin)', left: 'calc(var(--content-area-margin) + 10px + 100px + 24vmin)', transform: 'translate(-50%, 50%)' },
